...
type ReciboVentaDetalle = {
  numero: number
  fecha: string
  valor: number
  observaciones?: string | null
  documento?: DocumentoReciboVenta | null
...
export default async function DetalleReciboCajaPage({ params }: PageProps) {
  ...
  const detalle = recibo as ReciboVentaDetalle
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3 flex-wrap">
              <h1 className="text-xl font-bold text-gray-900">Recibo N° {detalle.numero}</h1>
          ...
          <div className="text-right">
            <p className="text-2xl font-bold font-mono text-green-700">{formatCOP(detalle.valor)}</p>
      ...
      <div className="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 p-5">
        ...
        <dl className="flex flex-col gap-2 text-sm">
          ...
          <div className="flex justify-between py-1 border-b border-gray-50">
            ...
            <dd className="font-mono font-bold text-green-700 text-base">{formatCOP(detalle.valor)}</dd>
          </div>
          <div className="flex justify-between py-1 border-b border-gray-50">
