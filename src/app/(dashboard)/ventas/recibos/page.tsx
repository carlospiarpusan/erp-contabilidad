    ...
    <div className="flex flex-col gap-6">
      ...
      <form className="flex flex-wrap gap-3 rounded-xl border border-gray-200 bg-white p-4">
        ...
        <div className="flex items-end gap-2">
          ...
          <Link href="/ventas/recibos" className="h-9 px-4 flex items-center rounded-lg border border-gray-300 text-sm text-gray-600 hover:bg-gray-50">Limpiar</Link>
        </div>
      </form>
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            {recibos.length === 0 ? (
              ...
              return (
                <tr key={r.id} className="hover:bg-gray-50 cursor-pointer" onClick={() => { window.location.href = `/ventas/recibos/${r.id}` }}>
