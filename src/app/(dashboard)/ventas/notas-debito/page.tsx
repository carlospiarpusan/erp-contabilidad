    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900 dark:text-white">Notas Débito</h1>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="rounded-xl border border-gray-100 bg-white dark:border-gray-800 dark:bg-gray-900 p-4">
          <p className="text-xs text-gray-500">Valor total cargado</p>
          <p className="text-xl font-bold font-mono text-amber-700 mt-0.5">{formatCOP(totalValor)}</p>
        </div>
      </div>
              ...
              return (
                <tr key={n.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                  <td className="px-4 py-3">
                    <Link href={`/ventas/notas-debito/${n.id}`} className="font-mono text-amber-600 hover:underline">
                      {n.prefijo}{n.numero}
                    </Link>
                  </td>
