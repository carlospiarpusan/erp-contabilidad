...
const API_ROUTE_RULES: readonly RouteRule[] = [
  ...
  { prefix: '/api/adjuntos', module: 'contabilidad' },
  { prefix: '/api/jobs', module: 'configuracion' },
  { prefix: '/api/contabilidad', module: 'contabilidad' },
  { prefix: '/api/documento-soporte', module: 'compras' },
  ...
  { prefix: '/api/export/libro-diario', module: 'contabilidad' },
  { prefix: '/api/export/libro-mayor', module: 'contabilidad' },
  { prefix: '/api/export/auxiliares', module: 'contabilidad' },
  { prefix: '/api/export/retenciones', module: 'contabilidad' },
  { prefix: '/api/export/faltantes-soporte', module: 'compras' },
  { prefix: '/api/export/exogena', module: 'contabilidad' },
