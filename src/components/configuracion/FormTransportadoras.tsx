      ...
      <table className="w-full text-sm">
        ...
        <tbody className="divide-y divide-gray-100">
          ...
          {inicial.length === 0 && !adding ? (
            ...
            <tr key={t.id} className={`hover:bg-gray-50 dark:hover:bg-gray-800/50 ${!t.activa ? 'opacity-50' : ''}`}>
              {editando === t.id ? (
                <>
                  <td className="px-4 py-2">
                ...
                <>
                  ...
                  <td className="px-4 py-3 text-center">
                    <button onClick={() => toggleActiva(t)}
                      className={`text-xs px-2 py-0.5 rounded-full font-medium ${t.activa ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500 dark:text-gray-400 dark:text-gray-500'}`}>
                      {t.activa ? 'Activa' : 'Inactiva'}
                    </button>
                  </td>
                  <td className="px-4 py-3 text-right">
                    <button onClick={() => iniciarEdit(t)}
                      className="p-1.5 rounded text-gray-400 hover:text-indigo-600 hover:bg-gray-100 dark:hover:bg-gray-800">
